...
| **docyrus-dashboard-design** | Build Docyrus dashboards, analytics, and reporting screens with a fixed, opinionated stack — Bklit UI for all charts, `AwesomeCard` for all panels, and `AwesomeStats` for all KPI/stat cards. Includes full prop references and end-to-end recipes wiring the stack onto Docyrus data. |
